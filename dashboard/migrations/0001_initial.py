# Generated by Django 5.1.2 on 2024-11-22 08:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('AwaitingPayment', 'Aguardando Pagamento'), ('Processing', 'Em processamento'), ('Shipped', 'Encaminhado'), ('Delivered', 'Entregue'), ('Cancelled', 'Cancelado')], default='AwaitingPayment', max_length=20)),
                ('total', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='dashboard.client')),
            ],
            options={
                'ordering': ['-created_at'],
            },
